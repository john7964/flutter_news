...
import 'package:flutter_news_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template flutter_news_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class FlutterNewsApiMalformedResponse implements Exception {
  /// {@macro flutter_news_api_malformed_response}
  const FlutterNewsApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template flutter_news_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class FlutterNewsApiRequestFailure implements Exception {
  /// {@macro flutter_news_api_request_failure}
  const FlutterNewsApiRequestFailure({
...
/// {@template flutter_news_api_client}
/// A Dart API client for the flutter_news API.
/// {@endtemplate}
class FlutterNewsApiClient {
  /// Create an instance of [FlutterNewsApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro flutter_news_api_client}
  FlutterNewsApiClient({
  ...
  ///
  /// {@macro flutter_news_api_client}
  FlutterNewsApiClient.localhost({
    required TokenProvider tokenProvider,
    http.Client? httpClient,
  }) : this._(
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw FlutterNewsApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        FlutterNewsApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
