...
void main() {
  ...
  group('FlutterNewsApiClient', () {
    late http.Client httpClient;
    late FlutterNewsApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = FlutterNewsApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = FlutterNewsApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => FlutterNewsApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = FlutterNewsApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws FlutterNewsApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<FlutterNewsApiMalformedResponse>()),
        );
      });

      test(
          'throws FlutterNewsApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<FlutterNewsApiRequestFailure>()
