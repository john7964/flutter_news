...
import 'package:firebase_notifications_client/notifications_client.dart';
import 'package:flutter_news/app/app.dart';
import 'package:flutter_news/main/bootstrap/bootstrap.dart';
import 'package:flutter_news/src/version.dart';
  ...
  bootstrap(
    (
      ...
      final packageInfoClient = PackageInfoClient(
        appName: 'flutter_news [DEV]',
        packageName: 'com.xiaoming.news.dev',
      ...
      final notificationsClient = createNotificationsClient();
